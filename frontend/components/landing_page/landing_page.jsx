          ...
          <div className="row">
            ...
            <div className="col-xs-6">
              <ul className="header-links pull-right hidden-xs">
                ...
                <li>
                  <a
                    href="https://www.linkedin.com/in/julian-compagni-portis-b52005b0"
                    target="_blank"
                  >
                    companies
                  </a>
          ...
          <div className="row inner-landing-content">
            <div className="col-sm-5 col-sm-offset-1 top-spacer">
              <h2 className="landing-tagline">
                Practice <span className="bold">Programming!</span>
              </h2>
              <p className="landing-info top-spacer">
                CodeFights is the most fun way to practice your programming
                skills. Master new languages, prepare for interviews, and much
                more! Join an active community of{" "}
                <span className="bold">500,000+</span> engineers!
              </p>
            </div>
            <div className="top-spacer visible-xs" />
            <div className="col-sm-5 signup-box">
              <button
                className="btn btn-primary fb-signup"
