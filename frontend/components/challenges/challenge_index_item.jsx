...
<<<<<<< HEAD
  <div className="sub-nav-item">
    ...
    <div className="sub-nav-item-title-container">
      <span className="sub-nav-item-title">{challenge.name}</span>
    ...
    <div className="bot-top-content">
      <img className ="bot-image" src={`/assets/${challenge.image_url}`} />
    ...
    {/* <Record
      data={[challenge.wins, challenge.losses, challenge.ties]}
      type="bots"
    /> */}
    </div>
  </div>
...
=======
    <div className="sub-nav-item">
      <div className="sub-nav-item-top">
        ...
        <div className="bot-top-content">
          <img className ="bot-image" src={`/assets/${challenge.img_url}`} />
          <div className= "bot-description">
            <p>{challenge.description}</p>
          </div>
          <Link to={`/bots/repl/${challenge.task_id}/${challenge.id}`}>
