  ...
  <div className="col-xs-12 sub-nav-item-container">
    <div className="sub-nav-item">
      ...
      <div className="sub-nav-item-bottom">
        <Record
          data={[challenge.attempts, challenge.completions, challenge.shortest]}
          type="challenges"
        />
      </div>
    </div>
